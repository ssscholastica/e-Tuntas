...
class PengajuanSantunan5 extends StatefulWidget {
  ...
  PengajuanSantunan5({required this.namaPTPN, required this.lokasiList, super.key});

  @override
  State<PengajuanSantunan5> createState() => _PengajuanSantunan5State();
}

class _PengajuanSantunan5State extends State<PengajuanSantunan5> {
  @override
  void initState() {
    super.initState();
    fetchKota();
  ...
  Future<void> uploadSantunan() async {
    ...
    try {
      final uri = Uri.parse('${baseURL}pengajuan-santunan5');
