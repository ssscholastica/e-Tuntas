...
class Persyaratan3 extends StatelessWidget {
  Persyaratan3({super.key});

  final List<Map<String, dynamic>> persyaratanList = [
    {
      "text":"Yang Meninggal Pensiunan PTPN X atau XI Kantor Pusat dan Istri Sudah Meninggal, Dalam KK Ada Beberapa Anak",
      "color": const Color(0xFFCFE2FF),
    },
    {
      "text":"Syarat copy berkas untuk pengajuan bantuan kematian pensiunan kantor pusat PTPN XI :",
      "sub-text":"1. Surat Kematian \n2. Kartu Keluarga (tercantum nama pensiunan & beberapa anak) \n3. Surat Kuasa dari semua anak, anak mana yang ditunjuk untuk menerima bantuan.\n4. KTP pensiunan & semua anak. \n5. Buku Rekening anak yang ditunjuk untuk menerima bantuan \n6. Besar bantuan adalah 4 kali manfaat pensiun \n",
      "sub-text2": "Catatan",
