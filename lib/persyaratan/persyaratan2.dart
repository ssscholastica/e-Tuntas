...
class Persyaratan2 extends StatelessWidget {
  Persyaratan2({super.key});

  final List<Map<String, dynamic>> persyaratanList = [
    {
      "text":"Yang Meninggal Pensiunan PTPN X atau XI Kantor Pusat dan Istri Sudah Meninggal, Dalam KK Ada 1 Anak",
      "color": const Color(0xFFCFE2FF),
    },
    {
      "text":"Syarat copy berkas untuk pengajuan bantuan kematian pensiunan kantor pusat PTPN XI :",
      "sub-text":"1. Surat Kematian \n2. Kartu Keluarga (tercantum nama suami & istri sesuai yang terdaftar di DAPENBUN) \n3. Surat Nikah \n4. KTP Suami Istri \n5. Buku Rekening Istri \n6. Besar bantuan adalah 4 kali manfaat pensiun",
      "sub-text2":"Catatan",
